...
class InstallRequirement(object):
    ...
    def build_location(self, build_dir):
        ...
        if self._temp_build_dir.source is not None:
            return self._temp_build_dir.source
        if self.req is None:
    ...
    def _correct_build_location(self):
        ...
        assert self._temp_build_dir.source
        assert (self._ideal_build_dir is not None and
                self._ideal_build_dir.source)  # type: ignore
        old_location = self._temp_build_dir.source
        self._temp_build_dir.source = None
        ...
        self._temp_build_dir.source = new_location
